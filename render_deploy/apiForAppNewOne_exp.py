...
configured_checkpoint = os.getenv("VIVIT_MODEL_PATH", "").strip()
fallback_checkpoint = "ekyc_checkpoint.pth"

for candidate in [configured_checkpoint, fallback_checkpoint]:
...
if DETECTOR_READY:
    ...
    print("ViViT checkpoint not found. Expected VIVIT_MODEL_PATH or ekyc_checkpoint.pth")
